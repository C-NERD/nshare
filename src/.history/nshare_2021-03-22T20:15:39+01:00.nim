...
try:
  var ip = $getPrimaryIPAddr()
  echo "\ntype " & ip & ":5000" & " in your url bar on the receiving device\n"

except OSError:
  echo "\nYou are not connected to a receiving device, make a connection to continue or use CTRL C to quit the application\n"
